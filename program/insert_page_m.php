...
{
 if($_FILES['manafacturefile']['name'])
 {
  $filename = explode(".", $_FILES['manafacturefile']['name']);
  if($filename[1] == 'csv')
  {
   $handle = fopen($_FILES['manafacturefile']['tmp_name'], "r");
   $data = fgetcsv($handle);
   ...
   while($data = fgetcsv($handle))
   {
    ...
    $query = "INSERT into manufacturer_order($name1, $name2, $name3, $name4, $name5, $name6, $name7, status) values('$item1','$item2','$item3','$item4','$item5','$item6','$item7','order delivered')";
...
<nav class="navbar navbar-inverse navbar-fixed-bottom" >
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="change_status_page_m.php">Change status page</a></li><!--改LINK + PAGE NAME -->
...
<h3>Insert Data</h3><br>
	<h4>Select manafacture's file :</h4>
	<input type="file" name="manafacturefile" id="manafacturefile">
    <br>
