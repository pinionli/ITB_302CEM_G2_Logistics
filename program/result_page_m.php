...
$sql = "SELECT exp_key, item_no, expected_shipment_date, qty, price_per_item, manufacturer_id, retailer_id, status FROM manufacturer_order where exp_key = " . $id;
...
<div class='row'>
	...
	<div class='col-sm-8'>
	<h4>". $row["price_per_item"] ."<!--輸出result --> </h4>
	</div>
</div>
<div class='row'>
	<div class='col-sm-4'>
